...
<div class="content"><div class="heading"><div><h1>{esc(title)}</h1><div class="sub">{esc(subtitle)}</div></div><div class="stats">{stats}</div></div><div class="grid">{body}</div></div></main></body></html>'''
